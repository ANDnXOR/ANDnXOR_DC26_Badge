...
ReturnObject *lulz_interpret_circle_stmt_node(StmtNode *, ScopeObject *);
...
ReturnObject *lulz_interpret_cursor_stmt_node(StmtNode *, ScopeObject *);
ReturnObject *lulz_interpret_cursor_area_stmt_node(StmtNode *node, ScopeObject *scope);
ReturnObject *lulz_interpret_delay_stmt_node(StmtNode *, ScopeObject *);
ValueObject *lulz_interpret_file_list_expr_node(ExprNode *node, ScopeObject *scope);
ReturnObject *lulz_interpret_fill_stmt_node(StmtNode *, ScopeObject *);
...
ReturnObject *lulz_interpret_line_stmt_node(StmtNode *, ScopeObject *);
...
ReturnObject *lulz_interpret_print_screen_stmt_node(StmtNode *, ScopeObject *);
...
ReturnObject *lulz_interpret_rect_stmt_node(StmtNode *, ScopeObject *);
ReturnObject *lulz_interpret_rect_filled_stmt_node(StmtNode *, ScopeObject *);
...
ReturnObject *lulz_interpret_timer_stmt_node(StmtNode *node, ScopeObject *scope);
