...
typedef enum {
  ...
  TT_ROUND,          /* Circle */
  TT_LAZER,          /* Cursor */
  TT_INSIDEZ,        /* Cursor Area */
  TT_LETR,           /* char type */
  TT_PAWS,           /* Delay */
  TT_SYSTUM,         /* System call */
  TT_ALL,            /* Fill */
  TT_CRAYON,         /* Font color */
  TT_MAH,            /* Global Set */
  TT_TEH,            /* Global Get */
  TT_CHEEZBURGER,    /* Validate Unlock */
  TT_L33T,           /* Get unlock state */
  TT_STRAIGHT,       /* Line */
  TT_DOT,            /* Pixel */
  TT_RICK_ROLL,      /* Play Bling */
  TT_KATNIP,         /* Draw bitmap (raw file) */
  TT_MEOW,           /* Print */
  TT_ROYGEEBIF2,     /* RGB to 565 */
  TT_HSSSVEE2,       /* HSV to 565 */
  TT_HSSSVEE2BLINKY, /* HSV to 565 */
  TT_BOX,            /* Rect */
  TT_CATINABOX,      /* Rect, Filled */
  TT_CATINAROUND,    /* Circle, Filled */
  TT_HOLLABACK,      /* Broadcast message */
  TT_SAY_WUT,        /* Get current message being broadcast" */
  TT_HOW_BIG,        /* Text height */
  TT_HOW_SPREAD,     /* Text width */
  TT_HOW_WIDE,       /* LCD Width */
  TT_HOW_TALL,       /* LCD Height */
  TT_HOW_MANY_IN,    /* Count BUKKIT items */
  TT_LOLOLOL,        /* Push screen buffer */
  TT_CRAZY_GO_NUTS,  /* Random */
  TT_OHIMEMBER,      /* Get setting value */
  TT_MEMBER,         /* Set setting */
  TT_MEOWMIX,        /* Get user input */
  TT_SHOUT,          /* Set font size */
  TT_TIX,            /* Get time millis */
  TT_TROLL,          /* Run file */
  TT_BADGEZ,         /* Badge peers */
  TT_CUT,            /* String char at index */
  TT_GNAW,           /* Substring */
  TT_YO,             /* String set char at index */
  TT_KOUNT,          /* String length */
  TT_DAB,            /* List of files in a directory */
  TT_NACHOS,         /* Run CHIP8 File */
  TT_WHO_DIS,        /* Get last broadcast received */

  /******* LULZCODE LEDs *******/
  TT_BLINK,    /* Set single LED */
  TT_BLINKIES, /* Set all LEDs */
  TT_LOLOL,    /* Push LED buffer */
  TT_WINK,     /* Control Eye LED */
  ...
  /******* LULZCODE Buttons ********/
  TT_POUNCE,     /* Wait for button */
  TT_BAD_KITTEH, /* Clear button state */
  TT_KITTEH,     /* Button state */
  TT_WHATSUP,    /* Is up pressed */
  TT_WHATSDOWN,  /*Is down pressed */
  TT_ISLEFF,     /* Is left pressed */
  TT_ISRIGHT,    /* Is right pressed */
  TT_WATTA,      /* Is A pressed */
  TT_WATTB,      /* Is B pressed */
  TT_ISGO,       /* Is start pressed */

  /******** LULZCODE I2C *****************/
  TT_NOM,  /* I2C Read byte */
  TT_NOMS, /* I2C Write byte */

  /************ LULZCODE Constants *************/
  TT_VERSHUN, /* Firmware version */
  TT_WHOAMI,  /* Get unique id */

  TT_ENDOFTOKENS /**< Sentinel end of this enum -- don't move it! */
} TokenType;

__attribute__((unused)) static const char* lulzcode_keywords[] = {
    "",            /* TT_INTEGER */
    "",            /* TT_FLOAT */
    "",            /* TT_STRING */
    "",            /* TT_IDENTIFIER */
    ...
    "BOX",            /* Rect */
    "CATINABOX",      /* Rect, filled */
    "CATINAROUND",    /* Circle, filled */
    "HOLLABACK",      /* Broadcast message */
    "SAY WUT",        /* Get current message being broadcast" */
    ...
    "OHIMEMBER",      /* setting value get */
    "MEMBER",         /* setting value set */
    ...
    "WHO DIS",        /* Get last broadcast received */
