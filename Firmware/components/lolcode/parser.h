...
typedef enum {
	...
	//LULZCODE Additions
	ST_BITMAP,		//KATNIP
	ST_BROADCAST,	//HOLLABACK
	ST_BUTTON_CLEAR,//BAD KITTEH
	ST_CHIP8,		//NACHOS
	ST_CIRCLE,		//ROUND
	ST_CIRCLE_FILLED, //CATINAROUND
	ST_COLOR_SET,	//CRAYON
	ST_CURSOR,		//LAZER
	ST_CURSOR_AREA, //INSIDEZ
	ST_DELAY,		//PAWS
	ST_FILL,		//ALL
	ST_FONT_SET,	//SHOUT
	ST_GLOBAL_SET,	//IZ MAH
	ST_I2C_WRITE,	//NOMS
	ST_LED_EYE, //WINK
	ST_LED_SET,		//BLINK
	ST_LED_SET_ALL, //BLINKIES
	ST_LED_PUSH,	//LOLOL
	ST_LINE,		//STRAIGHT
	ST_PIXEL, 		//DOT
	ST_PLAY_BLING,	//RICK ROLL WIT
	ST_PRINTSCREEN,	//MEOW
	ST_PUSHBUFFER,	//LOLOLOL
	ST_RECT,		//BOX
	ST_RECT_FILLED,	//CATINBOX
	ST_RUN,			//TROLL
	ST_STATE_SET,	//State value set Note: Getter is an expression
	ST_SYSTEM_CALL,	//SYSTUM
} StmtType;
...
typedef enum {
	...
	/** LULZCODE Additions **/
	ET_ARRAY_COUNT, //HOW MANY IN
	ET_BROADCAST_GET, //WHO DIS
	ET_BROADCAST_TX_GET, //SAY WUT
	ET_FILE_LIST,	//DAB
	ET_GLOBAL_GET,	//TEH
	ET_HSV_TO_565,	//HSV to 565
	ET_HSV_TO_RGB,	//HSV to RGB
	ET_RGB_TO_565,
	ET_INPUT,
	ET_TEXT_WIDTH,
	ET_TEXT_HEIGHT,
	...
	ET_RANDOM,
	ET_SERIAL,
	ET_STATE_GET,	//NOM - state set is a statement
	ET_STRING_GET_AT_INDEX, //CUT
	ET_STRING_SET_AT_INDEX,	//YO
	ET_STRING_LENGTH, //KOUNT
	ET_STRING_SUBSTRING, //GNAW
	ET_UNLOCK_GET, //L33T
	ET_UNLOCK_VALIDATE, //CHEEZBURGER
	...
	/** LULZCODE Buttons **/
	ET_BUTTON_STATE, //KITTEH
	ET_BUTTON_WAIT,	//POUNCE,
	ET_BUTTON_UP,
	ET_BUTTON_DOWN,
	ET_BUTTON_LEFT,
	ET_BUTTON_RIGHT,
	...
	/** Constants,  these will be replaced by the parser **/
	ET_FIRMWARE_VERSION,
} ExprType;
 ...
 *************************************************************************/
typedef struct {
	ExprNodeList *args;    //Generic statement node for lulzcode
} lulz_generic_stmt_node;

typedef struct {
	ExprNode *expr1;
	ExprNode *expr2;
	ExprNode *expr3;
} lulz_generic_expr_node;

void lulz_delete_expr_node(lulz_generic_expr_node *node);
void lulz_delete_stmt_node(lulz_generic_stmt_node *);
