 ...
 * 	@bitstr3m
 *****************************************************************************/
#ifndef COMPONENTS_ADDONS_H_
#define COMPONENTS_ADDONS_H_

/**
 * @brief Start the addons task which handles plug and play and animation in the
 * background
 */
extern void addons_task_start();

/**
 * @brief Start the addon
 */
extern void addons_start();

/**
 * @brief Stop the addon
 */
extern void addons_stop();

#endif /* COMPONENTS_ADDONS_H_ */
